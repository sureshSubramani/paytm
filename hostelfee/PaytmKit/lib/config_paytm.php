...
if(isset($_REQUEST['COLLEGE_ID']) && $_REQUEST['COLLEGE_ID']!=""){
	...
	/*echo 'MKEY: '.$merchant_key;
	echo '<br> MIT: '.$merchant_id;
	die;*/

	if($merchant_key && $merchant_id){

		define('PAYTM_ENVIRONMENT', 'TEST'); // PROD
		define('PAYTM_MERCHANT_KEY', '0goUgQaAetUzODo_'); //Change this constant's value with Merchant key received from Paytm.
		define('PAYTM_MERCHANT_MID', 'BMlhTx51177732171543'); //Change this constant's value with MID (Merchant ID) received from Paytm.
