...
if($MSISDN && $EMAIL && $ORDER_ID && $CUST_ID && $TXN_AMOUNT){
	...
	$paramList["CALLBACK_URL"] = "https://mahendra.org/online_payment/hostelfee/PaytmKit/paymentResponse.php?COLLEGE_ID=".$COLLEGE_ID;
	...
	<body>
		...
		<div class="text-center"><h4 style="display:none">Please do not refresh this page...</h4></div>
	...
	echo '<h4>Required value is missing!</h4>';
}?>