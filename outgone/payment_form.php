...
.type_of_payment input[type=radio]{
    font-size:14px;
    font-weight:600;
    padding:10px;
}
...
<div class="main-content" style="height: 100%; min-height: 500px">
    ...
    <div class="form-wrap">
        <form action="PaytmKit/paymentRedirect.php" method="post" name="payment_form" class="payment_form" id="payment_form">
            <table class="table borderless" border="1px" style="margin-top:0px !important; border:1px #ccc solid">
                <tr class='form_content'><td colspan="2"><h3 class="text-center">Online Fee Payment</h3></td></tr>
                <tr class='form_content'>
                    <td>Roll No.</td>
                    <td>
                      <input type="text" name="CUST_ID" id="roll_no" placeholder="Your Register/Roll Number" class="select_college" onblur="get_candidate(this.value)" required>
                    </td>
                </tr>
                <tr class='form_content'>
                    <td>Mobile Number</td>
                    <td>
                        <input type="text" name="MOBILE_NO" id="mobile" minlength="10" maxlength="10" class="select_college" placeholder="Max. 10 digits" required>&nbsp;
                ...
                <tr class="table borderless candidate_info" style="display: none">
                    <table class="table borderless candidate_info" style="display: none">
                        <tbody>
                            <td><strong class="month_info" style="font-size:14px">COVID 19:</strong> 
...
function validate_payment_form() {
    ...
    if (order_id && college_id && cust_id && mobile && email && amount >= 1000) {
    ...
    } else if (amount < 1000 || amount == "" || amount == undefined) {
        $("#form-msg").html('<span style="color:#f96">Enter amount (Minimum Rs.1000).</span>');
    } else {
