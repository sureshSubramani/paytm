...
if(isset($_REQUEST['otp_value']) && $_REQUEST['otp_value'] != ""){
        ...
        //if(isset($_SESSION['mobile_otp']) && $_SESSION['mobile_otp'] == $secret_code){
            ...
            if(isset($_REQUEST)){
                ...
                $college = isset($_REQUEST['college_name'])?$_REQUEST['college_name']:"";
                $roll_no = isset($_REQUEST['roll_no'])?$_REQUEST['roll_no']:"";

                if($mobile){

                    $sql = "SELECT * FROM hostel_candidate WHERE college_name='".$college."' AND (roll_no='".$roll_no."' OR hostel_code='".$roll_no."') AND status=1 AND payment_status=0";
