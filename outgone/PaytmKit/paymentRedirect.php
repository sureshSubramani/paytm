...
$checkSum = "";
$paramList = array();
$MSISDN = isset($_REQUEST["MOBILE_NO"])?$_REQUEST["MOBILE_NO"]:"";
$EMAIL = isset($_REQUEST["EMAIL"])?$_REQUEST["EMAIL"]:"";
$COLLEGE_ID = isset($_REQUEST["COLLEGE_ID"])?$_REQUEST["COLLEGE_ID"]:"";
$ORDER_ID = isset($_REQUEST["ORDER_ID"])?$_REQUEST["ORDER_ID"]:"";
$CUST_ID = isset($_REQUEST["CUST_ID"])?$_POST["CUST_ID"]:"";
$TXN_AMOUNT = isset($_REQUEST["TXN_AMOUNT"])?$_REQUEST["TXN_AMOUNT"]:"";
...
if($COLLEGE_ID && $MSISDN && $EMAIL && $ORDER_ID && $CUST_ID && $TXN_AMOUNT){
	...
	$paramList["CALLBACK_URL"] = "https://mahendra.org/online_payment/outgone/PaytmKit/paymentResponse.php?COLLEGE_ID=".$COLLEGE_ID;
