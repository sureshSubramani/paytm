...
#mobile_view .list-group-item,
#desktop_view .list-group-item {
    position: relative;
    display: block;
    padding: 5px 5px;
    margin-bottom: -1px;
...
<div class="main-content" style="height: 100%; min-height: 500px">
    <div class="fee-box">
        <div class="form-wrap m-top">
            <form action="" method="post" name="payment_form" class="payment_form pay-form" id="payment_form">
                <div class="table-responsive">
                    <table class="table borderless" cellspacing='0' cellpadding='0'>
                        <tr class='form_content'>
                            <td colspan="2">
                                <h3 class="pay-title text-center">Online Fee Payment</h3>
                            </td>
                        </tr>
                        <tr class='form_content'>
                            <td>Roll Number</td>
                            <td>
                                <input type="text" autocomplete="off" name="CUST_ID" id="roll_no" value="116UAE021"
                                    placeholder="Your Roll / Register Number" class="form-control select_college"
                                    onblur="get_candidate(this.value)" required>
                            </td>
                        </tr>
                        <tr class='form_content'>
                            <td>Mobile Number</td>
                            <td>
                                <input type="text" autocomplete="off" name="MOBILE_NO" id="mobile" value="8248182544"
                                    minlength="10" maxlength="10" class="form-control select_college"
                                    placeholder="Maximum 10 Digits" required>
                            </td>
                        </tr>
                        <tr class="candidate_info month_info" style="display: none;">
                            <td colspan="2">
                                <h3 class="pay-title text-center month_info">Online Fee Payment</h3>
                            </td>
                        </tr>
                        ...
                        <tr class="candidate_info" style="display: none;border-bottom: 1px solid #ccc;">
                            <td>Amount</td>
                            <td> <input type="number" class="form-control" name="TXN_AMOUNT" id="amount"
                        ...
                        <tr class="text-center">
                            <td colspan="2" style="text-align: center; paddig-top:-30px; position:relative;">
                                <div class="display_apps" style="display:none">
                                    <div id="mobile_view">
                                        <ul class="list-group">
                                            <li class="list-group-item list-group-item-info">App Payment Mode</li>
                                            <li class="list-group-item text-center">
                                                <img src="images/logo/app-payment/gpay.png" width="110" alt="paytm" />
                                            </li>
                                            <li class="list-group-item text-center">
                                                <img src="images/logo/app-payment/phone-pay.png" width="100"
                                                    alt="paytm" /></span>
                                            </li>
                                            <li class="list-group-item text-center">
                                                <img src="images/logo/app-payment/paytm.png" width="100" alt="paytm" />
                                            </li>
                                            <li class="list-group-item text-center"> Other Apps
                                            </li>
                                        </ul>
                                    </div>
                                    <div id="desktop_view">
                                        <ul class="list-group">
                                            <li class="list-group-item list-group-item-info">Other Payment Mode</li>
                                            <li class="list-group-item text-left"><br />Debit & Credit Cards <span
                                                    class="badge"><i class="fa fa-credit-card"></i></span></li>
                                            <li class="list-group-item text-left"><br />UPI ID & QR Code <span
                                                    class="badge"><i class="fa fa-qrcode"></i></span>
                                            </li>
                                            <li class="list-group-item text-left"><br />Netbanking <span
                                                    class="badge"><i class="fa fa-bank"></i></span></li>
                                        </ul>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr class="text-center">
                            <td colspan="2" style="text-align: center; paddig-top:-30px; position:relative;">
                                <span id="form-msg"
                                    style="color:red;display:block;top: -25px;position: relative;"></span>
                                ...
                                <input type="submit" id="paynow_btn" style="display: none;" />
                                ...
                                <div class="selecotr-item" id="paynow_btn2"
                                    style="position:relative;top:-20px;display: none;">
                                    <button type="button" id="paytm" name="type_payment" class="selector-item_label"
                                        onclick="validate_payment_form('paytm')">
                                        <span id="loader1"><span></span><span></span><span></span></span>
                                    </button>
                                    <button type="button" id="eazypay" name="type_payment" class="selector-item_label"
                                        onclick="validate_payment_form('icici')">
                                        <span id="loader2"><span></span><span></span><span></span></span>
                                    </button>
                                    <div>
                                        <span class="horizon-left">Powered by PayTM</span>
                                        <span class="horizon-right">Powered by ICICI</span>
                                    </div>
                                </div>
                ...
                <form id="otp_form" method="post" name="form" action="">
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="otp_number" name="otp_number" maxlength="6"
                                value=""
                                placeholder="<?php  echo isset($_SESSION[" mobile_otp "])?$_SESSION["mobile_otp "]:"6 Digits Number"; ?>"
                                autocomplete="off" required />
                            <div class="input-group-btn">
                                <input type="button" id="verify-btn" class="btn btn-lg btn-success"
                                    onclick="verify_mobile()" value=" OK ">
                            </div>
                        </div>
                    </div>
                </form>
...
$('#paytm').append(
    '<span class="paytm"> <span style="top:2px;left:5px;"> PAY NOW </span></span>'
);
$('#eazypay').append(
    '<span class="eazypay"> <span style="top:2px;left:5px;"> PAY NOW </span></span> '
);
...
function check_candidate() {
    ...
    if (roll_no == '') {
        ...
        setTimeout(() => {
            ...
            $("#form-msg").html(
                '<span class="label label-danger">Please Enter your Register/Roll Number</span>');
            $("#roll_no").focus();
        }, 500);
    } else if (mobile == '') {
        $('#loader').addClass("spinner");
        setTimeout(() => {
            $('.signature').css('display', 'block');
            $('#loader').removeClass("spinner");
            $("#form-msg").html('<span class="label label-danger">Please Enter Mobile Number</span>');
            $("#mobile").focus();
        }, 500);
    }
    if (roll_no != '' && mobile != '') {
...
function get_candidate(roll_no) {
    ...
    if (roll_no) {
        ...
        $("#form-msg").html('<span class="label label-danger">Please Enter Register/Roll Number</span>');
        $("#roll_no").focus();
...
$(document).ready(function() {
    ...
    $("#next").click(function() {
        ...
        if (mob != '' && mob.length == 10 && $.isNumeric(mob)) {
            ...
            setTimeout(() => {
                $("#form-msg").html(
                    '<span class="label label-danger">Please Enter Valid 10 Digits Mobile Number?</span>'
                ).css('color', 'red');
                $('.signature').css('display', 'inline');
                $('#loader').removeClass("spinner");
                $("#next").prop('disabled', false);
...
function validate_payment_form(type) {
    ...
    if (order_id && college_id && cust_id && mobile && email && amount >= 1) {
        ...
        $.ajax({
            ...
            data: 'order_id=' + order_id + '&college_id=' + college_id + '&cust_id=' + cust_id + '&mobile=' +
                mobile + '&email=' + email + '&amount=' + amount + '&gateway=' + type,
            beforeSend: function() {
            ...
            success: function(e) {
                ...
                if (res[1] != undefined) {
                    setTimeout(() => {
                        $("#form-msg").html('<span class="label label-danger">' + res[1] +
                            '</span>');
                        $('#eazypay').css('display', 'none');
                        $('.paytm').css('display', 'none');
                        $('#loader1').addClass("spinner");
        ...
        if (type == 'icici') {
            $('.eazypay').css('display', 'none');
            $('#paytm').css('display', 'none');
            $('#loader2').addClass("spinner");
            $("#eazypay").prop('disabled', true);
            setTimeout(() => {
                $("#form-msg").html('<span class="label label-danger">Unable submit data!</span>');
                $('.eazypay').css('display', 'inline-block');
                $('#paytm').css('display', 'inline-block');
                $('#loader2').removeClass("spinner");
                $("#eazypay").prop('disabled', false);
            }, 1000);
        }
