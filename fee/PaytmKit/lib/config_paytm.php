...
if(isset($_REQUEST['COLLEGE_ID']) && $_REQUEST['COLLEGE_ID']!=""){
	...
	if ($conn->connect_error) {
	  $update_message = '<h3 style="margin: 5% auto; text-align: center; color: #e80a0a">Connection failed. Unable to get merchant details.</h3>'; exit;
	}
	else{
	...
	//echo 'KEY: '.$merchant_key.', MID: '.$merchant_id; exit;
